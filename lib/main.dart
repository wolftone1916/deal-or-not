...
class _DealComparisonPageState extends State<DealComparisonPage> {
  ...
  Widget buildDealCard(int deal, double cardWidth) {
  ...
  Widget build(BuildContext context) {
    ...
    // Card width: ~46% of screen width, leaving room for padding/gap
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            children: [
              Text(
                'Enter the price and amount for each deal:',
                style: TextStyle(fontSize: 18),
              ),
              SizedBox(height: 20),
              SizedBox(
                height: 370, // enough to fit the card and photo preview
                child: SingleChildScrollView(
                  scrollDirection: Axis.horizontal,
                  child: Row(
                    children: [
                      buildDealCard(1, cardWidth),
                      buildDealCard(2, cardWidth),
                    ],
                  ),
                ),
              ),
